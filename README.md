...
本地已验证原数据包300只ETF及15个指数。数据文件仍在原仓库，本仓库不复制完整市场历史。远程 `main` 已公开发布 `0.1.0-candidate`，并通过 [GitHub Actions CI](https://github.com/Maureen-11/investing-clarity-moonbit/actions) 和 [Pages 演示](https://maureen-11.github.io/investing-clarity-moonbit/) 提供可运行版本；目录加载超时修复已通过 PR #2 合并。正式发布与原站接入状态见 [进度](docs/progress.md)。
